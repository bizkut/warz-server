...
public class WebHelper
{
    ...
    {
        return Param(paramName, false);
    }

    public string Param(string paramName, bool useGet)
    {
        string value = OptionalParam(paramName, useGet);
        if (value == null)
        {
#if true
            //@DEBUG
